...
class PDFGraph {
  ...
  async createGraph(containerNode) {
    ...
    const svg = d3
      .create("svg")
      .attr("id", "main-svg")
      // .attr("width", this.containerWidth)s
    ...
    const nodes = topGNode
      ...
      .join((enter) => {
        ...
        // draw vegalite graph
        const vlBorders = insightNode.append("g").attr("class", "vl-border");
    ...
    // topGNode.selectChildren(".node").each(function (d) {
    //   const vlBorder = d3.select(this).select(".vl-border");
    //   const svg = vlBorder.select("svg");
    //   const svgWidth = svg.attr("width");
    //   const svgHeight = svg.attr("height");

    //   const widthOffset =
    //     self.defaultConfig.iBorderWidth > svgWidth
    //       ? (self.defaultConfig.iBorderWidth - svgWidth) / 2
    //       : 0;
    //   const heightOffset =
    //     self.defaultConfig.iBorderHeight > svgHeight
    //       ? (self.defaultConfig.iBorderHeight - svgHeight) / 2
    //       : 0;
    //   vlBorder.style(
    //     "transform",
    //     `translate(${widthOffset}px, ${heightOffset}px)`
    //   );
    // });
