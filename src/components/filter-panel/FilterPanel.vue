                ...
                >
                    <transition name="slide">
                        <div
                            ...
                            v-show="insightData.isDescVisible"
                        >
                    ...
                    <div
                        :class="[
                            ...
                            {
                                isSelected:
                                    curRealId === insightData['real_id'],
                            },
                        ]"
                        v-loading="
                            isAddingNode &&
                            curAddingId === insightData['real_id']
                        "
                    ...
                    >
                        ...
                        <div class="btn-box">
                            ...
                            <SvgIcon
                                :class="[
                                    'icon',
                                    { 'has-desc': insightData.isDescVisible },
                                ]"
                                iconName="more"
        ...
        .insight-list-border {
            ...
            .wrapper {
                ...
                .insight-border {
                    ...
                    &:hover {
                        box-shadow: 0.1rem 0.5rem 0.5rem 0rem
